...
XPCOMUtils.defineLazyModuleGetter(this, "openLogFile", "resource://sessionmanager/modules/logger.jsm");
XPCOMUtils.defineLazyModuleGetter(this, "logging_level", "resource://sessionmanager/modules/logger.jsm");
...
var onLoad = function(aEvent) {
	...
	if (PreferenceManager.get("browser.preferences.instantApply", false, true)) {
...
function adjustContentHeight() {
	...
	var animate = PreferenceManager.get("browser.preferences.animateFadeIn", false, true);
	...
	document.documentElement._selector.selectedItem.click();
}
